...
// Connect to MongoDB
mongoose.connect('mongodb://localhost/room_booking', { useNewUrlParser: true, useUnifiedTopology: true });
...
app.get('/available', async (req, res) => {
    ...
    const bookings = await Booking.find({ room, dateTime: { $regex: `^${date}` } });
